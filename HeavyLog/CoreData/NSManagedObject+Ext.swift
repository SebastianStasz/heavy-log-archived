...
extension NSManagedObject {
    ...
    /// - Returns: A description of search criteria.
    static func createFetchRequest<T: NSManagedObject>(sortDescriptors: [NSSortDescriptor] = [], predicate: NSPredicate? = nil) -> NSFetchRequest<T> {
