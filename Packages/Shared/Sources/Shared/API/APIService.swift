...
public final class APIService: APIProvider {
    public static let shared = APIService()

    private let decoder = JSONDecoder()

    public func getData<T: Decodable>(from url: URL) -> AnyPublisher<T, AppError> {
    ...
    public func getData<T: Decodable>(fromFile fileName: String, withExtension fileExtension: String) -> AnyPublisher<T, AppError> {
